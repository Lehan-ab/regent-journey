...
export const COMPANIONS: Record<CompanionId, CompanionInfo> = {
  nova: {
    ...
    homeGreetings: [
      "“Welcome back, {name}. The path ahead awaits.”",
      "“Rotary Roots contains the foundational philosophy of service, {name}.”",
      "“Level {level} explorer status confirmed. Completing your next chronicle in {chapter} yields optimal XP, {name}.”",
      "“The eleven avenues represent distinct disciplines. We shall master them all in time, {name}.”",
  ...
  raya: {
    ...
    homeGreetings: [
      "“{name}! Another adventure is waiting.”",
      "“Hey {name}! The sun is high over {location}. What are we exploring first?”",
      "“Every step we take gets us closer to Pathfinder rank at Level {level}, {name}!”",
      "“I smell adventure near the botanical groves. Let’s move, {name}!”",
      "“Ready to jump into our next mission in {chapter}, {name}?”",
    ],
    themeColor: "#EA580C",
    accentColor: "#FFC719",
  },
  kai: {
    ...
    homeGreetings: [
      ...
      "“The roots of {location} run deep, {name}. Let us learn from them today.”",
      "“Level {level} reached. I see steady growth in your leadership with every chronicle completed, {name}.”",
      "“Whenever you are ready, {name}, {chapter} is open for our next strategic step.”",
    ],
    themeColor: "#10B981",
    accentColor: "#FFC719",
  },
