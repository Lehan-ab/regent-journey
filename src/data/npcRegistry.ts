...
export const NPC_REGISTRY: Record<string, NPCRegistryEntry> = {
  ...
  "archivist": {
    ...
    accentColor: "#10B981",
    portraits: {
      neutral: "/assets/pixel/characters/npcs/archivist/portrait.jpg",
      speaking: "/assets/pixel/characters/npcs/archivist/portrait.jpg",
      reaction: "/assets/pixel/characters/npcs/archivist/portrait.jpg",
    },
    isProductionAsset: true,
  },
  "port-master-kael": {
  ...
  "keeper": {
    ...
    bio: "Steward of the Seethawaka fortress hall, wearing charcoal and maroon tailored vestments with the crest key. The Keeper protects club camaraderie, meetings that move people, and club heritage.",
  ...
  "builder": {
    ...
    accentColor: "#D97706",
    portraits: {
      neutral: "/assets/pixel/characters/npcs/master_builder/portrait.jpg",
      speaking: "/assets/pixel/characters/npcs/master_builder/portrait.jpg",
      reaction: "/assets/pixel/characters/npcs/master_builder/portrait.jpg",
    },
    isProductionAsset: true,
  },
  "scholar": {
    ...
    accentColor: "#0D9488",
    portraits: {
      neutral: "/assets/pixel/characters/npcs/grand_scholar/portrait.jpg",
      speaking: "/assets/pixel/characters/npcs/grand_scholar/portrait.jpg",
      reaction: "/assets/pixel/characters/npcs/grand_scholar/portrait.jpg",
    },
    isProductionAsset: true,
  },
  "librarian-vanya": {
  ...
  "scout-mira": {
    ...
    accentColor: "#059669",
    portraits: {
      neutral: "/assets/pixel/characters/npcs/frontier_guide/portrait.jpg",
      speaking: "/assets/pixel/characters/npcs/frontier_guide/portrait.jpg",
      reaction: "/assets/pixel/characters/npcs/frontier_guide/portrait.jpg",
    },
    isProductionAsset: true,
  },
  "high-regent": {
    ...
    accentColor: "#EAB308",
    portraits: {
      neutral: "/assets/pixel/characters/npcs/high_regent/portrait.jpg",
      speaking: "/assets/pixel/characters/npcs/high_regent/portrait.jpg",
      reaction: "/assets/pixel/characters/npcs/high_regent/portrait.jpg",
    },
    isProductionAsset: true,
  },
};
