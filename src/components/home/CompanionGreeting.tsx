...
export default function CompanionGreeting() {
  ...
  const dialogues = [
    `“Rotary Roots is active. Your next lesson is Service Above Self.”`,
      ...
      <section className="w-full mb-5">
        <div className="flex items-center gap-3">
          ...
          <motion.div
            ...
            className="relative w-12 h-12 sm:w-14 sm:h-14 shrink-0 bg-[#050F2D] border-2 border-regent-gold/80 p-0.5 cursor-pointer group shadow-[0_3px_0_#02091F] hover:border-regent-gold transition-all"
          ...
          >
            ...
            <div className="absolute -bottom-2 -right-1 bg-regent-maroon px-1.5 py-0.2 border border-red-950 text-[7px] sm:text-[8px] font-pixel text-regent-gold font-bold shadow-sm">
              NOVA
            </div>
          </motion.div>
            ...
            <div className="flex items-center justify-between gap-2 mb-1">
              <div className="flex items-center gap-1.5 min-w-0">
                <span className="font-pixel text-[11px] sm:text-xs text-regent-gold font-bold uppercase tracking-wider flex items-center gap-1">
                  <Sparkles className="w-3 h-3 shrink-0" /> NOVA
                </span>
