  ...
  const allAchievements = [
    {
      id: "root-seeker",
      title: "ROOT SEEKER",
      description: "Discovered the history and origins of the Rotary movement.",
      xp: 150,
      unlocked: true,
    ...
    },
    {
      ...
      description: "Attended your first official Rotaract Seethawaka Regent general meeting.",
      xp: 100,
      unlocked: false,
      rarity: "COMMON",
    },
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 pt-4 sm:pt-6">
      ...
      <div className="text-center max-w-xl mx-auto mb-8">
        <div className="inline-flex p-3 bg-amber-950 border-2 border-regent-gold mb-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {allAchievements.map((badge) => (
          ...
          >
            {/* Badge Icon / Image */}
            <div className="relative w-16 h-16 shrink-0 bg-[#02091F] border-2 border-border-card flex items-center justify-center overflow-hidden">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between gap-1 mb-1">
                ...
                {badge.unlocked ? (
                  <span className="flex items-center gap-1 text-[10px] font-pixel text-regent-green">
              ...
              <div className="mt-2 text-[10px] font-pixel text-regent-gold flex items-center gap-1">
